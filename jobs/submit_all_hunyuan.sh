...
JOB_ID=$(sbatch --parsable "$SCRIPT_DIR/hunyuan_jobs/hunyuan_G26.slurm")
JOB_IDS+=($JOB_ID)
echo "  Job ID: $JOB_ID"
...
JOB_ID=$(sbatch --parsable "$SCRIPT_DIR/hunyuan_jobs/hunyuan_G49.slurm")
JOB_IDS+=($JOB_ID)
echo "  Job ID: $JOB_ID"

# Submit G-50_suppress_spurious_edges_data-generator
echo "Submitting: G-50_suppress_spurious_edges_data-generator"
JOB_ID=$(sbatch --parsable "$SCRIPT_DIR/hunyuan_jobs/hunyuan_G50.slurm")
JOB_IDS+=($JOB_ID)
echo "  Job ID: $JOB_ID"
