...
**Files**: `jobs/submit_all_hunyuan.sh`, 100 job scripts
...
3. **AGENT_HISTORY.md** - Complete deployment history (technical)
4. **TROUBLESHOOTING.md** - Common issues and solutions
5. **DEPLOYMENT_SUMMARY.md** - This file

### Setup Scripts (3 files)
1. **jobs/install_flash_attention.slurm** - Flash-attention compilation
2. **jobs/setup_hunyuan_only.sh** - Environment setup (ARM64-optimized)
3. **jobs/check_setup.sh** - Pre-flight validation

### Job Management (103 files)
1. **jobs/submit_all_hunyuan.sh** - Master submission script
2. **jobs/generate_all_hunyuan_jobs.py** - Job generator
3. **jobs/hunyuan_jobs/hunyuan_G*.slurm** - SLURM scripts (50)
4. **jobs/hunyuan_jobs/submit_hunyuan_G*.sh** - Submit helpers (50)
5. **jobs/README.md** - Jobs directory guide
6. **jobs/FLASH_ATTENTION_SUCCESS.md** - Flash-attention docs
...
| [jobs/README.md](jobs/README.md) | Jobs directory guide | Users |
| [jobs/FLASH_ATTENTION_SUCCESS.md](jobs/FLASH_ATTENTION_SUCCESS.md) | Flash-attention details | Technical users |
