...
**Key File**: `jobs/install_flash_attention.slurm`
...
### Documentation
- `AGENT_HISTORY.md` - This comprehensive history
- `jobs/FLASH_ATTENTION_SUCCESS.md` - Flash-attention installation guide
- `jobs/README.md` - Jobs directory organization

### Setup Scripts
- `jobs/install_flash_attention.slurm` - Flash-attention batch installation
- `jobs/setup_hunyuan_only.sh` - HunyuanVideo environment setup (ARM64-optimized)
- `jobs/check_setup.sh` - Pre-flight validation

### Job Management
- `jobs/submit_all_hunyuan.sh` - Submit all 50 inference jobs
- `jobs/generate_all_hunyuan_jobs.py` - Generate SLURM job scripts
- `jobs/hunyuan_jobs/hunyuan_G*.slurm` - Individual job scripts (50 files)
- `jobs/hunyuan_jobs/submit_hunyuan_G*.sh` - Individual submit scripts (50 files)
...
│   ├── FLASH_ATTENTION_SUCCESS.md  # Flash-attention documentation
│   │
│   ├── install_flash_attention.slurm  # Flash-attention installation
│   ├── setup_hunyuan_only.sh          # HunyuanVideo setup (ARM64-optimized)
│   ├── check_setup.sh                 # Pre-flight checks
│   │
│   ├── submit_all_hunyuan.sh          # Submit all 50 jobs
│   ├── generate_all_hunyuan_jobs.py   # Job generator
│   │
│   └── hunyuan_jobs/              # 100 job files (organized)
│       ├── hunyuan_G1.slurm       # SLURM job scripts (50)
│       ├── ...
│       ├── hunyuan_G50.slurm
│       ├── submit_hunyuan_G1.sh   # Individual submitters (50)
│       ├── ...
│       └── submit_hunyuan_G50.sh
│
...
**Missing checkpoints**: Run `jobs/setup_hunyuan_only.sh` to download models
**Protobuf errors**: Install `protobuf==3.20.3`

### Job Failures
**Check logs**: `logs/hunyuan_G*_<JOBID>.{out,err}`
**Common issues**:
- Flash-attention not installed → Run `install_flash_attention.slurm`
- Model checkpoints missing → Run `setup_hunyuan_only.sh`
