...
JOB_FILE="$PROJECT_ROOT/slurm/hunyuan-video-i2v/jobs/generated/hunyuan_G21.slurm"
...
echo "   tail -f video-reason-experiments/logs/hunyuan_G21_${JOB_ID}.out"
echo "   tail -f video-reason-experiments/logs/hunyuan_G21_${JOB_ID}.err"
echo ""
