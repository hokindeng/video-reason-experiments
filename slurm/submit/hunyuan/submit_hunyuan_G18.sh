...
JOB_FILE="$PROJECT_ROOT/slurm/hunyuan-video-i2v/jobs/generated/hunyuan_G18.slurm"
...
echo "   tail -f video-reason-experiments/logs/hunyuan_G18_${JOB_ID}.out"
echo "   tail -f video-reason-experiments/logs/hunyuan_G18_${JOB_ID}.err"
echo ""
