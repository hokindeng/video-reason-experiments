...
echo "     python3 slurm/hunyuan-video-i2v/jobs/generate_jobs.py"
echo ""
echo "  2. Review generated files in slurm/hunyuan-video-i2v/jobs/generated/"
echo ""
echo "  3. Submit jobs:"
echo "     ./slurm/submit/hunyuan/submit_all.sh      # All 50 jobs"
echo "     ./slurm/submit/hunyuan/submit_hunyuan_G1.sh       # Single job"
echo "     for i in {1..10}; do ./slurm/submit/hunyuan/submit_hunyuan_G\$i.sh; done  # First 10"
echo ""
