...
**Fix**: Run `sbatch slurm/hunyuan-video-i2v/setup/install_flash_attention.slurm`

### "Missing checkpoint directory"
**Fix**: Run `bash slurm/hunyuan-video-i2v/setup/setup_environment.sh`
...
- **Flash-attention issues**: See `slurm/hunyuan-video-i2v/docs/FLASH_ATTENTION.md`
- **Full history**: See `docs/AGENT_HISTORY.md`
- **Job organization**: See `slurm/README.md`
